...
export function PerspectiveScene3D({
  ...
  // Force synchronous offscreen render pass on mount or updates (e.g. when paused/stopped)
  React.useEffect(() => {
    ...
    // Invalidate R3F demand loop to force drawing the visualizer output
    invalidate();
  }, [
    gl,
    colorTarget,
    ...
    dofRenderHeight,
    dofRenderWidth,
    dofProperties.focusDistance,
    dofProperties.focalLength,
    dofProperties.bokehScale,
    children,
    invalidate,
  ]);
